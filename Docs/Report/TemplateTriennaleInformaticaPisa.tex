...
\usepackage{epigraph} % citazione
\usepackage{tikz} % grafo dipendenze

\usepackage[T1]{fontenc} % senza questo l'indice con l'aggiunta di 6. scompare.
...
\begin{center}
    ...
    \vspace{2cm}
    {\Large { PROGETTO PER ESAME DEL CORSO LABORATORIO II }}\\
    \vspace{2cm}
    {\Large { "Paroliere" videogioco scritto in C, multi-threaded, CLI, POSIX, client/server }}
\end{center}
...
\addcontentsline{toc}{chapter}{Note} % Capitolo non numerato
\input{note.tex}
